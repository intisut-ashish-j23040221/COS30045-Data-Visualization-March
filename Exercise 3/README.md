...
The target audience for the first visualisation includes:

- Policy makers and regulators interested in **Australian made televisions**
- Australian TV Manufacturers 
- Consumers interested in **locally-manufactured televisions**

These audiences are interested in understanding what are the current **leading countries in terms of manufacturing, and how much are they producing**, as well as the factors that lead the consumer to buy from foreign manufacturers.


The target audience for the second visualisation includes:

- TV Manufacturers that **sell TVs in Australia**
- Consumers interested in **energy-efficient televisions**

These audiences are interested in understanding how **TV Screen Technology can impact the energy consumption**, as well as the factors that lead to the results.


### Story Overview

The first visualisation explores patterns in **amount of manufactured TVs** across different countries.

The goal is to help viewers understand:

- What countries currently manufacture **the most amount of TVs**
- Where Australia lies in terms of **manufacturing**
- Risks that may include if there is **no improvement for Austrlian-manufactured TVs**
- Suggestions on how to get consumers to support **Austrlian-manufactured TVs**



The second visualisation explores patterns in **TV energy consumption** across different screen technologies.

The goal is to help viewers understand:

- How energy consumption varies between **screen technologies**
- The relationship between **screen technologies and power consumption**
- Trends that may help consumers choose more **energy-efficient televisions**
- Suggestions to make other screen technologies more **energy-efficient**
...
The dataset was sourced from: https://data.gov.au/
Download link: https://data.gov.au/data/dataset/559708e5-480e-4f94-8429-c49571e82761/resource/93a615e5-935e-4713-a4b0-379e3f6dedc9/download/tv_2026_03_28.csv
...
- Converting existing data into familiar scale
...
Artificial Intelligence (AI) tools have been used to assist with aspects of this assignment, as stated in the following:
